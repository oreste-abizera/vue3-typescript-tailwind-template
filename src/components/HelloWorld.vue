<template>
  <div class="prose max-w-none">
    ...
    <p>
      ...
      <a
        href="https://github.com/oreste-abizera/vue3-typescript-tailwind-template"
        >GitHub</a
      >. It uses <a href="https://github.com/vitejs/vite">vite</a> to provide a
    ...
    <p>
      ...
      <router-link to="/about"> another page </router-link> or to a page that
      <router-link to="/foo"> does not exist </router-link>.
    </p>
    <h2>Installing</h2>
    <p>
    ...
    <pre><span class="text-gray-500"># clone the template</span>
git clone https://github.com/oreste-abizera/vue3-typescript-tailwind-template {{ name || '&lt;project-name&gt;' }}
